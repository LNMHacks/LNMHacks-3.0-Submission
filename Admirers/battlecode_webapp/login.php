<?php
	...
	if(loggedin())
		...
		$username = array_key_exists('username', $_POST) ? mysqli_real_escape_string($con,trim($_POST['username'])) : "";
		if($_POST['action']=='login') {
			...
			// register the user
      $email = array_key_exists('email', $_POST) ? mysqli_real_escape_string(trim($_POST['email'])) : "";
