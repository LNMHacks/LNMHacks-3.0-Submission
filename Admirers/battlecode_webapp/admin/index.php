            ...
            <li class="nav-header">ADDED PROBLEMS</li>
          	  ...
          	  if(mysqli_num_rows($result)==0)
          	    ...
          	    while($row = mysqli_fetch_array($result)) {
          	      if(isset($_GET['action']) and $_GET['action']=='edit' and isset($_GET['id']) and $_GET['id']==$row['sl']) {
          	        $selected = $row;
          	        echo("<li class=\"active\"><a href=\"index.php?action=edit&id=".$row['sl']."\">".$row['name']."</a></li>\n");
          	      } else
          	        echo("<li><a href=\"index.php?action=edit&id=".$row['sl']."\">".$row['name']."</a></li>\n");
          	    }
          	  }
          	?>
          	<li class="divider"></li>
          	<?php
          	  if(!isset($_GET['action']) and !isset($_GET['id']))
          	    ...
          	    echo("<li><a href=\"index.php\">Add problem</a></li>\n");
          	?>
          </ul>
          <hr/>
          <?php
