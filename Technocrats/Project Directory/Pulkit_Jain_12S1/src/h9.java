 ...
 * @author hp1
 */
public class h9 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(h9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
