...
% %% Check the latest value for total number of faces
  [initialNum,latestDate] = thingSpeakRead(618292,'ReadKey','FRDLVUSNXHHR65GQ');
...
%  data in the channel.
vidObj = webcam('EasyCamera','Resolution','640x480');
faceDetector = vision.CascadeObjectDetector('MaxSize',[150 150]);%'MinSize',[50 45]); % Finds faces by default tracker = MultiObjectTrackerKLT;
